...
class ListCotgoryAdapter :
    ListAdapter<Listcotegory, ListCotgoryAdapter.ListViewHolder>(DiffUtils()) {
    val oclick: ((Int) -> (Unit))? = null


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        val inflater =
            LayoutInflater.from(parent.context).inflate(R.layout.list_padcotegory, parent, false)
